...
export const AboutSection: React.FC<AboutSectionProps> = ({
  ...
  useGSAP(() => {
    // Animate the marker moving down the line
    if (timelineRef.current && markerRef.current) {
      ...
      // Animate each timeline card as the marker (or scroll) reaches it
      ...
      cards.forEach((card: any, i) => {
        gsap.fromTo(card, 
          { 
            y: 100, 
            opacity: 0,
            x: i % 2 === 0 ? -50 : 50 // Slide in from alternating sides on desktop
          },
          {
            scrollTrigger: {
              trigger: card,
              start: "top 60%", // Triggers when the top of the card hits 60% of viewport
            },
            y: 0,
            x: 0,
            opacity: 1,
  ...
  return (
    <section ref={sectionRef} id="about" className="py-20 md:py-32 relative bg-pink-50 overflow-hidden">
      {/* Abstract Background pattern */}
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#ec4899 2px, transparent 2px)', backgroundSize: '30px 30px' }} />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="space-y-6 mb-24 max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-slate-900 shadow-[4px_4px_0px_0px_rgba(236,72,153,1)] text-sm font-black text-slate-900 uppercase tracking-widest -rotate-2">
          ...
          <p className="text-slate-700 text-lg sm:text-2xl font-bold max-w-3xl mx-auto leading-snug bg-white p-4 border-l-8 border-pink-500 shadow-[4px_4px_0px_0px_rgba(15,23,42,0.1)] rotate-1">
        ...
        <div className="relative max-w-5xl mx-auto" ref={timelineRef}>
          ...
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 md:-ml-0.5 bg-slate-200 border-x-2 border-slate-900 border-dashed" />
          
          {/* Moving Marker */}
          <div 
            ref={markerRef}
            className="absolute left-8 md:left-1/2 top-0 w-10 h-10 -ml-5 -mt-5 bg-pink-500 border-4 border-slate-900 rounded-full flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] z-20"
          >
          ...
          <div className="space-y-16 md:space-y-24">
            ...
            <div className="timeline-card relative flex flex-col md:flex-row justify-between items-center w-full pl-20 md:pl-0">
              <div className="md:w-5/12 w-full md:pr-12 md:text-right">
            ...
            <div className="timeline-card relative flex flex-col md:flex-row justify-between items-center w-full pl-20 md:pl-0">
              <div className="hidden md:block w-5/12" />
              <div className="hidden md:block w-2/12" />
              <div className="md:w-5/12 w-full md:pl-12">
